 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sun Nov 18 16:34:23 2018
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME fixpicontrol
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES           "__SFB__fixregul.c__SFB__fixpoint.c"
#define PANELINDEX            6
...
extern void fixpicontrol_Outputs_wrapper(const real_T *u0,
			real_T *y0,
			const real_T *xD,
			const real_T *gain, const int_T p_width0,
			const real_T *Ti, const int_T p_width1,
			const real_T *scale, const int_T p_width2);
extern void fixpicontrol_Update_wrapper(const real_T *u0,
			real_T *y0,
			real_T *xD,
			const real_T *gain, const int_T p_width0,
			const real_T *Ti, const int_T p_width1,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T *gain = (const real_T *) mxGetData(PARAM_DEF0(S));
    const real_T *Ti = (const real_T *) mxGetData(PARAM_DEF1(S));
    const real_T *scale = (const real_T *) mxGetData(PARAM_DEF2(S));
    
    fixpicontrol_Outputs_wrapper(u0, y0, xD, gain, p_width0, Ti, p_width1, scale, p_width2);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    fixpicontrol_Update_wrapper(u0, y0, xD, gain, p_width0, Ti, p_width1, scale, p_width2);
}
