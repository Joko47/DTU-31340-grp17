 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
 * Created: Wed Oct 24 13:34:04 2018
 * 
 *
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME regultest
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES "__SFB__regul.c"
#define PANELINDEX           6
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    regultest_Outputs_wrapper(u0, y0, xD, b0, p_width0, b1, p_width1, a1, p_width2);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    regultest_Update_wrapper(u0, y0,  xD, b0, p_width0, b1, p_width1, a1, p_width2);
}
