...
#define S_FUNCTION_NAME picontrol
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void picontrol_Outputs_wrapper(const real_T *u0,
                          real_T *y0 ,
			      const real_T  *xD,
                          const real_T  *gain, const int_T  p_width0, 
                          const real_T  *Ti, const int_T p_width1);
extern void picontrol_Update_wrapper(const real_T *u0,
                          const real_T *y0 ,
                          real_T *xD, 
                          const real_T  *gain,  const int_T  p_width0,
                           const real_T *Ti, const int_T  p_width1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    picontrol_Outputs_wrapper(u0, y0, xD, gain, p_width0, Ti, p_width1);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    picontrol_Update_wrapper(u0, y0,  xD, gain, p_width0, Ti, p_width1);
}
